...
import 'package:handwerksapp/features/user/presentation/user_profile.dart';

class WorkerScreen extends StatefulWidget {
  final Cubit userStateCubit;
  final User user;
  const WorkerScreen(
      {super.key, required this.userStateCubit, required this.user});
